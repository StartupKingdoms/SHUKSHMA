...
exports.serve = exports.setup = void 0;
...
function setup(opts, options, customCss, customfavIcon, swaggerUrl, customSiteTitle) {
...
exports.serve = [swaggerInitFn, swaggerAssetMiddleware()];
var serveWithOptions = function (options) { return [swaggerInitFn, swaggerAssetMiddleware(options)]; };
