...
var RepositoryException = /** @class */ (function (_super) {
    __extends(RepositoryException, _super);
    function RepositoryException(error) {
        ...
        _this.response_message = response_message_1.RESPONSE_MESSAGE.REPOSITORY_ERROR;
        return _this;
    }
